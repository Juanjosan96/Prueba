...
se pasa como parámetro.*/
    public static boolean nextprimo(int pri) {
...
//entero. Se empieza contando por el 0 y de izquierda a derecha
   ...
   public static int digitoN(int n,int d){
    int posicion=0;
    int digitos=digitos(n)-1;
    for(int i=0;i<digitos-d;i++){//quitar parte derecha
    n/=10;
}
    n=Integer.parseInt(voltea(n));
    for(int i=0;i<d;i++){n/=10}
    n=Integer.parseInt(voltea(n));//quitar parte izquierda
    return n;
    */
